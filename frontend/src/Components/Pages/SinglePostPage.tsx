...
import { useSinglePostQuery } from "../../hooks/usePostsQuery";
import {
...
export default function SinglePostPage() {
  ...
  const isHomeLoading = isUserListLoading || isSpacesLoading;
  ...
  return (
    <div className="flex h-screen bg-[#090e1a] overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto pb-20 lg:pb-0">
        ...
        <div className="max-w-3xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-8 pb-12">
          ...
          {isPostLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-rose-500">
              ...
              <p className="text-sm mt-1 text-slate-500">This post may have been deleted or doesn't exist.</p>
            </div>
          ) : post ? (
            <div className="space-y-4">
              {(() => {
                ...
                const common = {
                  key: post._id,
                  postId: post._id,
                  type: post.type || (post.video ? 'video' : post.images ? 'image' : 'blogpost'),
