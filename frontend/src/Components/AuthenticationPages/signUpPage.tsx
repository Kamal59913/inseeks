...
export default function SignUpPage({ togglepage }: SignUpPageProps) {
  ...
  const handleSignUp = (values: Record<string, unknown>) => {
    const payload = preprocessTrimmedFormData(values) as {
      fullname: string;
      username: string;
      email: string;
      password: string;
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 relative overflow-hidden p-12">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-slate-400 text-lg max-w-md leading-relaxed">
            Join the fastest growing community of creators and professionals. Share ideas, grow your network,
