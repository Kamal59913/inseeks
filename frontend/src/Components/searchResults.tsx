...
export default function SearchResults() {
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {people.map((person, i) => (
                    <div
                      key={i}
 className="flex items-center gap-3 bg-[#111827] rounded-xl p-4 transition-all group"
                    >
                      <ImageWithFallback
                        variant="avatar"
                        src={person.avatar}
 ...
 <div className="bg-[#111827] rounded-xl flex flex-col items-center justify-center py-20 text-slate-500">
