...
const onLikeClick = () => {
  ...
  return (
    ...
    <div className="flex items-center m-2">
                      ...
                      <div className='ml-[212px] mb-3'><i class="fa-solid fa-ellipsis-vertical"></i></div>
    </div>
  <p className="text-base font-semibold ml-4">{props.title} </p>

<div className="my-4 ml-7 h-[200px] w-[330px] rounded-md object-cover grid grid-cols-6 grid-rows-6 gap-2">
