...
export default function ImageHomepage() {
  ...
  return (
    <div className={styles.questionCard}>
      ...
      <div className={styles.column1b2} onClick={() => navigate('/images')}>
        <p className={styles.postTitleQuestion}> Images of Cancun Mexico</p>
      </div>
      <div className={styles.column1b3Img} onClick={() => navigate('/images')}>
