...
import ServiceCategoriesFilter from "./serviceCategoriesFilter/serviceCategoriesFilter";

const ServiceCategoriesModule: React.FC = () => {
  ...
  return (
    <>
      <PageMeta
        title={`Explore Service Category Management Directory ${HEADER_CONFIG.NAME}`}
      ...
      <ModuleHeader
        ...
        is_reverse={true}
        isMultiLine={true}
        destination_path="add-service-category"
        footerContent={
...
export default ServiceCategoriesModule;
