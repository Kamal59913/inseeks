...
const ServiceCategoriesFilter: React.FC<
  ServiceCategoriesFilterProps & { filters: FilterState }
    ...
    >
      ...
      >
        ...
        <div className={isMultiLine ? "col-span-12 md:col-span-6 lg:col-span-3" : ""}>
          ...
          <Button onClick={() => navigate("add-service-category")} size="sm" className={isMultiLine ? "px-8" : ""}>
            Add Service
          </Button>
        </div>
      </div>
...
export default ServiceCategoriesFilter;
