...
import { couponCodeDiscountOptions } from "@/utils/couponCodeDiscount";
        ...
        >
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="cstm-input">
                <Label isRequired={true}>Discount Type</Label>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <SingleSelectDropdown
                      title=""
                      options={couponCodeDiscountOptions}
                      value={field.value}
                      onChange={(val) => {
                        field.onChange(val); // <-- still update RHF
                      }}
              ...
              <div className="cstm-input">
                ...
                <div className="cstm-input">
                <Label isRequired={true}>Flat Discount</Label>
                <NumberInputV2
                  placeholder="Flat Discount"
                  registerOptions="flat_discount"
                  register={formMethods?.register}
                  errors={formMethods.formState.errors}
                  autoFocus={true}
                  maxLength={3}
              ...
              <div className="cstm-input">
                <Label isRequired={true}>Duration in months</Label>
                <NumberInputV2
                  placeholder="Duration in months"
                  registerOptions="duration_in_months"
                  register={formMethods?.register}  
                  errors={formMethods.formState.errors}
                  autoFocus={true}
                  maxLength={3}
