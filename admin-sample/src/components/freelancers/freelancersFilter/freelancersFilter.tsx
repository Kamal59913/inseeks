...
interface FreelancersFilterProps {
...
const FreelancersFilter: React.FC<
  FreelancersFilterProps & { filters: FilterState }
> = ({ onFilterChange, onClearFilters, filters, isMultiLine = false }) => {
  ...
  const handleExportCSV = async () => {
    const response = await freelancersService.exportFreelancers(filters);
